    ...
    *,
    ...
    while openq:
        ...
        for nb in neighbors(cur):
            tentative = gs + grid_px  # 四邻接，步长就是 grid_px
...
def route_rect_with_walls(
    ...
    # 仍然失败时，最后兜底（允许“贴墙但不穿越”的 L 形）
    # 你也可以 raise Exception 提醒人工介入
    return cand
...
def route_with_jb_strategy(
    ...
    *,
    ...
    panel_radius=12.0,
    wire_width=1.0,
    walls: Optional[List[List[Point]]] = None,  # <--- 新增
