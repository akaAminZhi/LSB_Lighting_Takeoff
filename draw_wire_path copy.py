...
def place_and_draw_jb_only(
    ...
    *,
    ...
    jb_xy, dev2jb, groups = auto_place_junction_boxes(
        dets,
        capacity=capacity,
        eps_px=eps_px,
        grid_px=grid_px,
    ...
    out.close()
    doc.close()
    return {"num_jb": len(jb_xy), "groups": {k: v for k, v in groups.items()}}
...
if __name__ == "__main__":
    ...
    for device in DEVICE_LABEL:
        ...
        # info1 = place_and_draw_jb_only(
        #     input_pdf=input_pdf,
        #     output_pdf=output_pdf_jb,
        ...
        #     merge_eps=50,
        #     min_conf=0.30,
        #     keep_labels=None,  # None=除了 PANEL 都要
        #     jb_radius=10.0,
        # )
        # print("JB only:", info1)
